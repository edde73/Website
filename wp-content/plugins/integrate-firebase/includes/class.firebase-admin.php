...
class Firebase_Admin{
  ...
  public static function load_firebase_admin_js() {
    ...
    wp_enqueue_script( 'firebase_database', 'https://www.gstatic.com/firebasejs/5.1.0/firebase-database.js', array(), FIREBASE_WP_VERSION, false );
    wp_enqueue_script( 'firebase_firestore', 'https://www.gstatic.com/firebasejs/5.1.0/firebase-firestore.js', array(), FIREBASE_WP_VERSION, false );
